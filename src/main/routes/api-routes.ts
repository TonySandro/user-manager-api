...
import { makeGetAllAccountsController } from "../factories/get-all-accounts/get-all-accounts-factory";
...
export default (router: Router): void => {
  ...
  router.get("/get-all-accounts", adaptRoute(makeGetAllAccountsController()));
};
